...
vida1_jugador2 = vida_image.get_rect(midbottom=(300,380))
vida2_jugador2 = vida_image.get_rect(midbottom=(280,380))
vida3_jugador2 = vida_image.get_rect(midbottom=(260,380))
...
def mostrar_menu():
    ...
    img1 = font1.render("Monkey Space!",True,RED)
...
def mostrar_credits():
    ...
    SONS = fontcredit.render("FREESOUND.ORG", True, RED)

    pantalla.blit(CREDIT, (170, 300))
    pantalla.blit(CREDIT2, (170, 380))
    pantalla.blit(CREDIT3, (170, 440))
    pantalla.blit(SONS, (170, 500))
